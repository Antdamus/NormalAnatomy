...
- Target deck: `Corebook::All Categories::Neuro::Brain::Introduction to Brain Neoplasms and Cysts::Colloid Cyst`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::All Categories::Neuro::Brain::Introduction to Brain Neoplasms and Cysts::Colloid Cyst`
...
Created: 2026-06-22T22:32:16.794Z