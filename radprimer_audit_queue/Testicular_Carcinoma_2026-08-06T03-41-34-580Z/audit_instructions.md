...
- Target deck: `Corebook::Ultrasound::Scrotum Basic::Testicular Carcinoma`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::Ultrasound::Scrotum Basic::Testicular Carcinoma`
...
Topic: Testicular Carcinoma
Engine/mode: pathology/chatgpt_cards
Created: 2026-08-06T03:41:34.580Z