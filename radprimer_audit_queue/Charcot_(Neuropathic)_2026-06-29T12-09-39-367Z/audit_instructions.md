...
- Target deck: `Corebook::MSK::Trauma::Introduction to Osseous Trauma::Charcot (Neuropathic)`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::MSK::Trauma::Introduction to Osseous Trauma::Charcot (Neuropathic)`
...
Topic: Charcot (Neuropathic)
Engine/mode: pathology/chatgpt_cards
Created: 2026-06-29T12:09:39.367Z