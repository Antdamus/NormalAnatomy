...
- Target deck: `Corebook::GI::Liver::Widespread Low Attenuation Within Liver`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::GI::Liver::Widespread Low Attenuation Within Liver`
...
Created: 2026-09-09T03:01:09.438Z