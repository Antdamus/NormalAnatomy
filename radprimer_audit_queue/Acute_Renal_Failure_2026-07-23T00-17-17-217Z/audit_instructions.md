...
- Target deck: `Corebook::Nuclear Medicine::Genitourinary Basic::Acute Renal Failure`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::Nuclear Medicine::Genitourinary Basic::Acute Renal Failure`
...
Created: 2026-07-23T00:17:17.217Z