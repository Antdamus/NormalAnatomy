...
- Target deck: `Corebook::Neuro::Brain::Primary Effects of CNS Trauma::Subacute Subdural Hematoma`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::Neuro::Brain::Primary Effects of CNS Trauma::Subacute Subdural Hematoma`
...
Created: 2026-07-06T23:30:27.815Z