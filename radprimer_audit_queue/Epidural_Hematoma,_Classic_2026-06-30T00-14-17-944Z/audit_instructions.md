...
- Target deck: `Corebook::Neuro::Brain::Primary Effects of CNS Trauma::Epidural Hematoma, Classic`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::Neuro::Brain::Primary Effects of CNS Trauma::Epidural Hematoma, Classic`
...
Created: 2026-06-30T00:14:17.944Z