...
- Target deck: `Corebook::GI::Liver::Focal Liver Lesion With Hemorrhage`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::GI::Liver::Focal Liver Lesion With Hemorrhage`
...
Created: 2026-09-11T11:32:49.514Z