...
- Target deck: `Corebook::Ultrasound::Scrotum Basic::Testicular Torsion/Infarction::Testicular Torsion`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::Ultrasound::Scrotum Basic::Testicular Torsion/Infarction::Testicular Torsion`
...
Created: 2026-07-30T10:55:24.225Z