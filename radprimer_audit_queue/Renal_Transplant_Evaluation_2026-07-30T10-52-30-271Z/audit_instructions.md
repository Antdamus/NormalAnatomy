...
- Target deck: `Corebook::Nuclear Medicine::Genitourinary Basic::Renal Transplant Evaluation`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::Nuclear Medicine::Genitourinary Basic::Renal Transplant Evaluation`
...
Topic: Renal Transplant Evaluation
Engine/mode: pathology/narrative
Created: 2026-07-30T10:52:30.271Z