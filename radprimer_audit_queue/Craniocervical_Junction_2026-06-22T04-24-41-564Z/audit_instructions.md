...
- Target deck: `Corebook::All Categories::Intermediate::Neuro::Spine::Anatomy::Spinal Osseous Structures, Ligaments, and Muscles::Craniocervical Junction`
- Create `corrected_cards_anki_import.tsv` by prepending these lines to the corrected TSV rows:
  `#separator:tab`
  `#html:true`
  `#notetype:core_rad_notetype_v2`
  `#deck:Corebook::All Categories::Intermediate::Neuro::Spine::Anatomy::Spinal Osseous Structures, Ligaments, and Muscles::Craniocervical Junction`
...
Created: 2026-06-22T04:24:41.564Z